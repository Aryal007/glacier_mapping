...
if __name__ == "__main__":
    classes = ["Wetlands", "Impervious", "Agriculture", "Snow", "Water", "Soil", "Forest"]
    labels = [4, 1, 2, 7, 6, 5, 3]
    _threshold = [20, 5, 25, 15, 15, 15, 15]
    ...
    models = []
    for c in classes:
        model_path = data_dir / "runs" / c / "models" / "model_final.pt"
