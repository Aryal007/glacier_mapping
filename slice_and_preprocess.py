...
val_filenames = sorted(list(set([x+'.tif' for x in train_df.image_id if x.split("_")[1] in val_ids])))
train_filenames = sorted(list(set([x+'.tif' for x in train_df.image_id if x.split("_")[1] not in val_ids])))
